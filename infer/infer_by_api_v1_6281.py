...
deepseek_output_path = os.path.join(base_dir, "output/deepseek/dev.csv")
        ...
        for attempt in range(MAX_RETRIES + 1):
            try:
                ...
                response = self.client.chat.completions.create(
                    ...
                    messages=[
                        {"role": "system", "content": "You are a helpful assistant specializing in translation."},
